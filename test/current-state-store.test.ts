...
test("schema v7 migration preserves Events, Pi sessions, outbox, and reminders", async () => {
...
test("schema v7 adds external verification metadata to an existing v4 Action table", async () => {
